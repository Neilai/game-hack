// hideproc.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
BOOL InjectAllProcess(int nMode, LPCTSTR szDllPath)
{
	...
	//	// 矫胶袍狼 救沥己阑 困秦辑
	//	// PID 啊 100 焊促 累篮 矫胶袍 橇肺技胶俊 措秦辑绰
	//	// DLL Injection 阑 荐青窍瘤 臼绰促.
	//	if (dwPID < 100)
	//		continue;
...
int _tmain(int argc, TCHAR* argv[])
{
	...
	// load library
	hLib = LoadLibrary(L"D:\\VS-project\\Dll1\\x64\\Debug\\Dll1.dll");
	...
	InjectAllProcess(nMode, L"D:\\VS-project\\Dll1\\x64\\Debug\\Dll1.dll");
